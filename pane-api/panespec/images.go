...
// validateImageName validates that the image name is not empty or a path traversal sequence.
// Fixed path traversal vulnerabilities where input names could escape base directories.
